...
static function String GetGameModeFriendlyString(String InGameMode)
{
    ...
    switch(InGameMode)
    {
        ...
        case ("UTGameContent.UTVehicleCTFGame_Content"):
            ...
            break;
		// KRIS 1:07 AM 11/04/2012
		// FIXME - do this properly! (subclass / override this or something)
        case ("TFP.tfpGame"): 
            RetString = "Deathmatch";
            break;
        case ("TFP.tfpTeamGame"):                 
            RetString = "Team Deathmatch";
            break;
        case ("TFP.tfpVehicleCTFGame"):
            RetString = "Capture the Flag";
            break;
		// KRIS
        default:
...
DefaultProperties
{
	...
	// KRIS 1:07 AM 11/04/2012
	// FIXME - *UGH*, hate doing this kinda thing...
	DefaultGameMode="TFP.tfpGame" // "UTGame.UTDeathmatch"
	// KRIS
